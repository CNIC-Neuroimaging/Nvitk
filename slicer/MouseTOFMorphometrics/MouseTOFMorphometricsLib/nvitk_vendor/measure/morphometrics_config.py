...
# Source: src/nvitk/measure/morphometrics_config.py
...
(:mod:`nvitk_vendor.pipes.qvtpy.stage7_morphometrics`) via
:mod:`nvitk_vendor.pipes.qvtpy.util.eicab.morpho_paths` and
:mod:`nvitk_vendor.pipes.qvtpy.config` layout constants — not here.
"""
...
class MorphometricsConfig:
    ...
    # block; see :mod:`nvitk_vendor.measure.morpho.anatomy_axes`.
    species: str = "auto"
