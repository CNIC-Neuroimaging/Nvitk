...
# Source: src/nvitk/measure/morpho/anatomy.py
...
from nvitk_vendor.measure.morphometrics_config import EXPORT_ANATOMIC_SPLIT_CENTERLINES, TREE_REGION_ROLE_CODES
...
def anatomical_endpoint_score(
    ...
    the subject's species (see :mod:`nvitk_vendor.measure.morpho.anatomy_axes`).
