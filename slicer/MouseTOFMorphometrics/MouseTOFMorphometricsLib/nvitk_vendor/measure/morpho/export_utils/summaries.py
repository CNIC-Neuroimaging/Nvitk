...
# Source: src/nvitk/measure/morpho/export_utils/summaries.py
...
from nvitk_vendor.measure.morpho.anatomy import tree_region_metadata
from nvitk_vendor.measure.morphometrics_config import TREE_REGION_ROLE_CODES
from nvitk_vendor.measure.morpho.geometry import arc_length, chord_length, cumulative_s
from nvitk_vendor.measure.morpho.metrics import tortuosity_dm
...
def compute_volumetry_summary(
    ...
    built by :func:`nvitk_vendor.measure.morpho.run_case.label_input_volumetry`) adds
