...
# Source: src/nvitk/measure/morpho/tree_segments.py
...
def build_connected_skeleton_edge_segments(tree: SkeletonTree, spacing) -> List[dict]:
    ...
    Uses :func:`~nvitk_vendor.morphology.centerline.unique_skeleton_edge_polylines` so
    ...
    """
    from nvitk_vendor.morphology.centerline import unique_skeleton_edge_polylines
