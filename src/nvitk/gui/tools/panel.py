...
def build_tool_panel(
    ...
    *,
    ...
    @magicgui(
        ...
        mouse_modality={"choices": ["t2", "t1"], "label": "Mouse modality", "value": "t2"},
        which_parcellation={"label": "Parcellation scheme", "value": "nick"},
        brain_modality={
            "choices": [
                "t1",
                "t1nobrainer",
        ...
        prediction_batch_size={"label": "MRA prediction batch size", "min": 1, "max": 64, "value": 16},
