...
def build_tool_panel(
    ...
    *,
    ...
    @magicgui(
        ...
        join_gap_vox={
            "label": "Join vessel pieces (voxels)",
            "min": 0,
            "max": 50,
            "value": 8,
        },
        ...
        skeletonize_mode={
            "label": "Skeletonize input",
            "widget_type": "ComboBox",
            "choices": ["auto", "always", "never"],
            "value": "auto",
        },
        prune_spur_points={"label": "Prune spurs under N points", "min": 0, "max": 200, "value": 0},
        bridge_max_gap={"label": "Bridge gaps up to N voxels", "min": 0, "max": 50, "value": 0},
    ...
    def tool_panel(
        ...
        branch_id: int,
        reskeletonize: bool,
        skeletonize_mode: str,
        prune_spur_points: int,
        bridge_max_gap: int,
        suv_kind: str,
        philips_factor: bool,
        revert_scaling: bool,
