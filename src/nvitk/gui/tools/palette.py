...
_QUICK_OPS: tuple[tuple[str, str, tuple[str, ...], str, dict[str, Any]], ...] = (
    ...
    (
        "qk_ct_window",
        "CT display window…",
        ("ct", "hu", "hounsfield", "window", "level", "brain", "bone", "lung",
         "angio", "stroke", "soft tissue", "mediastinum", "liver", "subdural"),
        "ct_window",
        {},
    ),
    (
        "qk_adjust",
        "Adjust gamma / log / sigmoid…",
        ("gamma", "log", "logarithmic", "sigmoid", "curve", "exposure", "brighten", "darken"),
        "adjust_intensity",
        {},
    ),
    (
        ...
        ("equalize", "equalise", "clahe", "adaptive", "histogram", "contrast"),
        "equalize_histogram",
        {},
    ),
    (
        "qk_rescale",
        "Rescale intensity…",
        ("rescale", "stretch", "normalize", "normalise", "range", "percentile"),
        "rescale_intensity",
        {},
    ),
    (
        "qk_histogram",
        "Show histogram…",
        ("histogram", "hist", "distribution", "counts", "plot"),
        "show_histogram",
        {},
    ),
    (
        "qk_contours",
        "Find contours…",
        ("contour", "isoline", "outline", "marching", "trace", "boundary"),
        "find_contours",
        {},
    ),
    (
        "qk_flood",
        "Flood fill from cursor…",
        ("flood", "fill", "magic wand", "region", "bucket", "connected"),
    ...
    (
        "qk_watershed",
        "Watershed split…",
        ("watershed", "split", "separate", "touching", "basins", "segment"),
        "watershed_split",
        {},
    ),
