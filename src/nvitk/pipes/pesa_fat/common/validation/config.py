...
OUT_DIR             = BASE / "RESULTS" / "Validation_202602"
...
AUTO_WEEK_FMT       = f"{AUTO_MONTH}_Week{w}"   # formato del nombre de carpeta/fichero

# ── Ficheros intermedios / de salida ──────────────────────────────────────────
MANUAL_TABLE_PATH   = MANUAL_PATH / "Manual_Measurements.xlsx"
