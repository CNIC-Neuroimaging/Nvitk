...
COMPARISONS = {
    ...
    "SUV_Cuadriceps": {
        ...
        "modality": "SUV",
        "pairs": [
            {"label": "Cu\u00e1d. bilateral\nSUVmax",  "manual": "man2_Cuad_BIL_SUVmax", "auto": "CUADRICEPS_LR_SUVMAX",  "units": "SUV", "xlabel": "Manual bilateral (n=6)"},
            {"label": "Cu\u00e1d. bilateral\nSUVmean", "manual": "man2_Cuad_BIL_SUVmed", "auto": "CUADRICEPS_LR_SUVmean", "units": "SUV", "xlabel": "Manual bilateral (n=6)"},
    ...
    "SUV_Paravertebral": {
        ...
        "modality": "SUV",
        "pairs": [
            {"label": "Paravert. bilateral\nSUVmax",  "manual": "man2_Paravert_BIL_SUVmax", "auto": "PARAVERTEBRAL_LR_SUVMAX",  "units": "SUV", "xlabel": "Manual bilateral (n=6)"},
            {"label": "Paravert. bilateral\nSUVmean", "manual": "man2_Paravert_BIL_SUVmed", "auto": "PARAVERTEBRAL_LR_SUVmean", "units": "SUV", "xlabel": "Manual bilateral (n=6)"},
    ...
    "DIXON_Rinon": {
        ...
        "modality": "DIXON",
        "pairs": [
            {"label": "Ri\u00f1\u00f3n bilateral\nFF",  "manual": "man2_Rinon_BIL_FF", "auto": "DIXON_KIDNEY_LR_FF", "units": "%",  "xlabel": "Manual bilateral (n=6)"},
            {"label": "Ri\u00f1\u00f3n bilateral\nT2*", "manual": "man2_Rinon_BIL_T2", "auto": "DIXON_KIDNEY_LR_T2", "units": "ms", "xlabel": "Manual bilateral (n=6)"},
    ...
    "DIXON_Musculo": {
        ...
        "modality": "DIXON",
        "pairs": [
            {"label": "Cu\u00e1d. bilateral\nFF",  "manual": "man2_Cuad_BIL_FF", "auto": "DIXON_L_QM_LR_FF", "units": "%",  "xlabel": "Manual bilateral (n=6)"},
            {"label": "Cu\u00e1d. bilateral\nT2*", "manual": "man2_Cuad_BIL_T2", "auto": "DIXON_L_QM_LR_T2", "units": "ms", "xlabel": "Manual bilateral (n=6)"},
    ...
    "DIXON_Volumenes": {
        ...
        "pairs": [
            {"label": "Ri\u00f1\u00f3n bilateral\nVOL (cc)", "manual": "man2_Rinon_BIL_VOL", "auto": "DIXON_KIDNEY_LR_VOL", "units": "cc", "xlabel": "Manual bilateral (cc)", "ylabel": "Auto (cc)"},
            ...
            {"label": "Cu\u00e1d. bilateral\nVOL (cc)",      "manual": "man2_Cuad_BIL_VOL",  "auto": "DIXON_L_QM_LR_VOL",   "units": "cc", "xlabel": "Manual bilateral (cc)", "ylabel": "Auto (cc)"},
...
PAIR_COLS = [
    ...
    ("man2_Cuad_BIL_SUVmax",     "CUADRICEPS_LR_SUVMAX",      "Cuad BIL SUVmax",       "SUV"),
    ("man2_Cuad_BIL_SUVmed",     "CUADRICEPS_LR_SUVmean",     "Cuad BIL SUVmean",      "SUV"),
    ...
    ("man2_Paravert_BIL_SUVmax", "PARAVERTEBRAL_LR_SUVMAX",   "Paravert BIL SUVmax",   "SUV"),
    ("man2_Paravert_BIL_SUVmed", "PARAVERTEBRAL_LR_SUVmean",  "Paravert BIL SUVmean",  "SUV"),
    ...
    ("man2_Rinon_BIL_FF",        "DIXON_KIDNEY_LR_FF",        "Rinon BIL FF",          "%"),
    ("man2_Rinon_BIL_T2",        "DIXON_KIDNEY_LR_T2",        "Rinon BIL T2*",         "ms"),
    ...
    ("man2_Cuad_BIL_FF",         "DIXON_L_QM_LR_FF",          "Cuad BIL FF",           "%"),
    ("man2_Cuad_BIL_T2",         "DIXON_L_QM_LR_T2",          "Cuad BIL T2*",          "ms"),
